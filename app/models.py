...
class Upvoted(db.Model):
    __tablename__ = 'upvoted'
    upvoter_id = db.Column(db.Integer, db.ForeignKey('users.id'),
                            primary_key=True)
...
class Downvoted(db.Model):
    ...
    downvoter_id = db.Column(db.Integer, db.ForeignKey('users.id'),
                            primary_key=True)
